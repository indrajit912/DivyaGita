...
class EmailService:
    ...
    @staticmethod
    def send_email(to_emails, subject, body_html=None, body_text=None, from_name="DivyaGita", from_email=None):
    ...
    def send_otp_email(cls, email, otp):
        ...
        subject = "Verify Your DivyaGita Account - OTP"
        body_html = f"""
        <html>
            <body style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; line-height: 1.6; color: #212529; padding: 20px;">
                <div style="max-width: 600px; margin: 0 auto; border: 1px solid #e9ecef; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 6px rgba(0,0,0,0.05);">
                    <div style="background-color: #1a1a2e; color: #f5a623; padding: 20px; text-align: center;">
                        <h1 style="margin: 0; font-size: 24px; font-weight: bold; color: #f5a623;">Divya<span style="color: #ffffff;">Gita</span></h1>
                    </div>
                    <div style="padding: 30px; background-color: #ffffff;">
                        <h2 style="color: #1a1a2e; margin-top: 0;">Confirm Your Email Address</h2>
                        <p>Thank you for registering an account on DivyaGita. Please enter the following One-Time Password (OTP) to verify your account and activate your contributor profile:</p>
                        <div style="background-color: #fcf8e3; border: 1px solid #faebcc; padding: 15px; text-align: center; margin: 25px 0; border-radius: 6px;">
                            <span style="font-size: 32px; font-weight: 800; letter-spacing: 4px; color: #d43f3a; font-family: monospace;">{otp}</span>
                        </div>
    ...
    def send_password_reset_email(cls, email, reset_url):
        ...
        subject = "Reset Your DivyaGita Password"
        body_html = f"""
        <html>
            <body style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; line-height: 1.6; color: #212529; padding: 20px;">
                <div style="max-width: 600px; margin: 0 auto; border: 1px solid #e9ecef; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 6px rgba(0,0,0,0.05);">
                    ...
                    <div style="padding: 30px; background-color: #ffffff;">
                        <h2 style="color: #d43f3a; margin-top: 0;">Password Reset Request</h2>
                        <p>We received a request to reset the password for your DivyaGita account. Click the button below to secure a new password:</p>
                        <div style="text-align: center; margin: 30px 0;">
                            <a href="{reset_url}" style="background-color: #f5a623; color: #ffffff; padding: 12px 24px; text-decoration: none; border-radius: 5px; font-weight: bold; display: inline-block;">Reset Password</a>
                        </div>
